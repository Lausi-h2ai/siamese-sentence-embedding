...
def genetic_hyperparam_search(data_loader, device,vocab_size, embedding_weights,config_dict, mutation_chance=0.25, num_candidates=8,batch_size=128, output_size=128,embedding_size=300,bidirectional=True, max_epochs=25, num_gens=10):
    ...
    for generation in range(num_gens):
        ...
        for hyperparameters in models:
            logging.info("Starting train for model with parameters hidden_size={},lstm_layers={},fc={},dropout={},a_hs={},a_os={},p={}, lr={}, o_size={}".format(hyperparameters['c']['hidden_size'],hyperparameters['c']['lstm_layer'],hyperparameters['c']['fc'],hyperparameters['c']['dropout'],hyperparameters['c']['a_hs'],hyperparameters['c']['a_os'],hyperparameters['c']['a_p'],hyperparameters['c']['lr'], hyperparameters['c']['output_size']))
            ## Make a new model from the hyperparameters and train it
            model = make_model(hyperparameters, batch_size=batch_size, vocab_size=vocab_size,embedding_size=embedding_size,embedding_weights=embedding_weights,device=device,bidirectional=bidirectional)
        ...
        for hyperparameters in sorted_model_list:
            logging.info("model with score {} and parameters hidden_size={},lstm_layers={},fc={},dropout={},a_hs={},a_os={},p={}, lr={}, o_size={}".format(hyperparameters['val_acc'], hyperparameters['c']['hidden_size'],hyperparameters['c']['lstm_layer'],hyperparameters['c']['fc'],hyperparameters['c']['dropout'],hyperparameters['c']['a_hs'],hyperparameters['c']['a_os'],hyperparameters['c']['a_p'],hyperparameters['c']['lr'], hyperparameters['c']['output_size']))
    ...
    for model in models:
        logging.info("Final list model: hidden_size={},lstm_layers={},fc={},dropout={},a_hs={},a_os={},p={}, lr={}, o_size={}".format(hyperparameters['c']['hidden_size'],hyperparameters['c']['lstm_layer'],hyperparameters['c']['fc'],hyperparameters['c']['dropout'],hyperparameters['c']['a_hs'],hyperparameters['c']['a_os'],hyperparameters['c']['a_p'],hyperparameters['c']['lr'], hyperparameters['c']['output_size']))

    return models[0]



def make_model(hyperparameters, batch_size, vocab_size, embedding_size, embedding_weights, device, bidirectional=True):
    '''
